module.exports = {
    ...
    execute(message) {
        ...
        .setColor('#db2b39')
        .setTitle('Help Page')
        .setDescription('Hi there! I am Solaris, your virtual assistant on Appl3 PvP. I have very limited functionality right now, but I can provide useful links and info about the server simply by executing commands.')
        .addFields(
